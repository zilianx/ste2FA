...
export default async function handler(req, res) {
  ...
  try {
    ...
    const UPSTASH_REST_URL = process.env.https://healthy-buzzard-36822.upstash.io;
    const UPSTASH_REST_TOKEN = process.env.AY_WAAIncDI0NDU0ZDU1MjkwMmE0NDdjOTdlNzU0ZTliZGYyYjM5M3AyMzY4MjI;
    ...
    const SITE_URL = (process.env.https://s2-fa.vercel.app/ || "").replace(/\/$/, "");
